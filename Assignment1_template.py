...
if __name__ == "__main__":
    ...
    new_graph_wiki, node_id_map = map_node_ids(graph_wiki)
    
    # To revert back to old graph ids use following command
    '''
    graph_wiki = revert_node_ids(new_graph_wiki, node_id_map)
    '''
    ...
    #graph_partition_wiki  = girvan_newman_one_level(new_graph_wiki)
    ...
    # Question 1
    graph_partition_lastfm = girvan_newman_one_level(graph_lastfm)

    # Question 2
    community_mat_lastfm = girvan_newman(graph_lastfm)

    # Question 3
    visualise_dendogram(community_mat_lastfm)

    # Question 4
    graph_partition_louvain_lastfm = louvain_one_iter(graph_lastfm)
